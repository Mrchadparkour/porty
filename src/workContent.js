...
export default [
  ...
  },
  {
    ...
    image: form,
    desc: "A simple form I made for blendedMarket over a couple weekends, complete with a node backend, React and Redux! Don't worry Mr. BlendedMarket knows its on my Github.",
